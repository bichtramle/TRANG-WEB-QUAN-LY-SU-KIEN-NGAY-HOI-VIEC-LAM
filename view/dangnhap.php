...
<input type="text" required  name="user" placeholder="Nhập tên đăng nhập" />
<input required name="pass" type="password" placeholder="Nhập mật khẩu" />
<input type="checkbox" id="checkbox" name="checkbox"><label class="checkbox-text">Nhớ đăng nhập lần sau</label>
<input class="text-danger" type="submit" name="login" value="Đăng nhập" />
