                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <div class="footer-box">
                                    <p class="title-bold-light text-white title-bar-left ">Liên Hệ Hợp Tác
Điện thoại: 0243.788.00.99 (8:30 - 17:00)

Hotline: 08.999.80.818<br>

Email: ticketgo.vn@gmail.com<br>

Địa chỉ: Số 1, Phạm Văn Bạch, phường Yên Hòa, quận Cầu Giấy, Hà Nội.</p>
                                 
                            </div>
                            </div>
                            <div class="col-xl-4 col-lg-3 col-md-6 col-sm-12">
                                <div class="footer-box">
                                    <p class="text-white title-bold-light title-bar-left ">Thông tin
Về chúng tôi
Khuyến mãi
Phương thức thanh toán
Chính sách bảo mật và các điều khoản
Hướng dẫn đặt vé
                        ...
                        <div class="row">
                            <div class="col-12 text-center">
                                <a href="index.html" class="footer-logo img-fluid">
                                    <img src="Public/client/img/ctu4.png" alt="logo" class="img-fluid">
                                </a>
                                <ul class="footer-social">
                                    <li>
                                        <a href="https://www.facebook.com/CTUDHCT" title="facebook">
